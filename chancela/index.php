...
<head>
    ...
    <meta name="description" content="DocMark - Sinal Público">
...
<body>
    <div class="page-wrapper">
        ...
        <main class="main-content">
            ...
            <div class="page-header animate-fade-in">
                <h1 class="page-title">
                    <i class="fa-solid fa-signature" style="color: var(--color-accent-light);"></i>
                    Sinal Público
                </h1>
                <p class="page-subtitle">Adicione o sinal público (chancela) em suas Matriculas de Imóveis</p>
            </div>
                ...
                <div class="card-body">
                    <form action="upload.php" method="POST" enctype="multipart/form-data" id="uploadForm">
                        ...
                        <div class="flex justify-center mt-6">
                            <button type="submit" name="submit" class="btn btn-primary btn-lg" id="btnProcessar">
                            ...
                            ?>
                                <li class="list-item">
                                    ...
                                    <div class="list-item-actions">
                                        <a href="<?= 'http://' . $_SERVER['HTTP_HOST'] . '/docmark/chancela/arquivos/' . basename($arquivoZIP) ?>" class="btn btn-primary btn-sm">
    ...
    <div id="loadingModal" class="modal-backdrop">
        <div class="modal" style="text-align: center; max-width: 350px;">
            ...
            <h3 style="margin-bottom: 8px;">Processando Arquivos...</h3>
            <p style="color: var(--color-gray-400); margin: 0;">Por favor, aguarde enquanto os arquivos estão sendo processados.</p>
        </div>
    </div>
    ...
    <script>
        ...
        // Form submit with validation and loading
        document.getElementById('uploadForm').addEventListener('submit', function(e) {
            ...
            if (files.length === 0) {
                ...
                Swal.fire({
                    ...
                    text: 'Por favor, selecione pelo menos um arquivo PDF para processar.',
